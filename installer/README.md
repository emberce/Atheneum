...
https://github.com/project/Wallets <br />
...
2.4 Put the server IP address ( your vultr ip or other vps/vm ip) followed by the port :0000 <br />
2.5 Put the private key generated in step 1.3 <br />
2.6 Put the transaction hash and output id from step 1.7 <br />
Example below

```
MN01 124.842.07.0:0000 119cCx5YeA519YkTzun4EptdexAo3RvQXaPdkP 838328ce57cc8b168d932d138001781b77b22470c05cf2235a3284093cb0019db 0
```
...
```
cd ~
wget https://raw.githubusercontent.com/project/installers/master/installer.sh
