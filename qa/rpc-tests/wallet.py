...
#   c) node1 mines 32 blocks, so now node 0 has 60001AEM, node 1 has 4250AEM, node2 has none.
#   d) node0 sends 601 AEM to node2, in two transactions (301 AEM, then 300 AEM).
