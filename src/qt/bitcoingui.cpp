                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Atheneum Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Atheneum address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and atheneum: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zAEM"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Atheneum Core"), this);
    aboutAction->setStatusTip(tr("Show information about Atheneum Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Atheneum"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Atheneum addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Atheneum addresses"));
    ...
    openAction->setStatusTip(tr("Open a Atheneum: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Atheneum Core help message to get a list with possible Atheneum command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Atheneum Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Atheneum network", "", count));
}
...
{
    QString strTitle = tr("Atheneum Core"); // default title
