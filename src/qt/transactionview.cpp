                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received AEM from zAEM"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zAEM"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zAEM));
